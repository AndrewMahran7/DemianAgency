...
const faqs = [
  ...
  ["How will the agency contact me?", "Choose phone, email, or text as your preferred contact method. Final response timing and contact details will be added once the agency confirms them."],
] as const;
