...
export const metadata: Metadata = {
  title: "About | Demian Insurance Agency",
  description: "Learn about the personal approach behind Demian Insurance Agency and meet founder Mina Demian.",
};

export default function AboutPage() {
  return (
    <RouteShell eyebrow="About" title="An agency relationship, built around people." description="Demian Insurance Agency brings a personal, considered approach to protecting homes, vehicles, families, and businesses across Southwest Florida.">
