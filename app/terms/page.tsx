  ...
  return (
    <LegalPage eyebrow="Information" title="Website Terms of Use" introduction="These terms explain the role of this website and what happens when you request a quote, service, or other assistance from Demian Insurance Agency online.">
      ...
      <LegalSection title="Changes and contact">
        <p>We may update these terms by posting a revised version and changing the date shown above. Questions may be sent to <a href="mailto:mina@demianinsurance.com">mina@demianinsurance.com</a> or directed to <TrackedPhoneLink location="legal" href="tel:+19413771806">(941) 377-1806</TrackedPhoneLink>.</p>
      </LegalSection>
    </LegalPage>
  );
}
